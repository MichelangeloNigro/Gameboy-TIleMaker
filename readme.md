...
<details open>
	<summary><b><code>C:\USERS\MICHE\DOCUMENTS\SCUOLA\GAMEBOY-TILEMAKER/</code></b></summary>
	<!-- __root__ Submodule -->
	<details>
...
Build Gameboy-TIleMaker from the source and intsall dependencies:

1. **Clone the repository:**

    ```sh
    ❯ git clone ../Gameboy-TIleMaker
    ```

2. **Navigate to the project directory:**

    ```sh
    ❯ cd Gameboy-TIleMaker
    ```
...
Gameboy-tilemaker uses the {__test_framework__} test framework. Run the test suite with:
...
- **💬 [Join the Discussions](https://LOCAL/Scuola/Gameboy-TIleMaker/discussions)**: Share your insights, provide feedback, or ask questions.
- **🐛 [Report Issues](https://LOCAL/Scuola/Gameboy-TIleMaker/issues)**: Submit bugs found or log feature requests for the `Gameboy-TIleMaker` project.
- **💡 [Submit Pull Requests](https://LOCAL/Scuola/Gameboy-TIleMaker/blob/main/CONTRIBUTING.md)**: Review open PRs, and submit your own PRs.
...
2. **Clone Locally**: Clone the forked repository to your local machine using a git client.
   ```sh
   git clone C:\Users\miche\Documents\Scuola\Gameboy-TIleMaker
   ```
...
<br>
<p align="left">
   <a href="https://LOCAL{/Scuola/Gameboy-TIleMaker/}graphs/contributors">
      <img src="https://contrib.rocks/image?repo=Scuola/Gameboy-TIleMaker">
   </a>
</p>
</details>
...
Gameboy-tilemaker is protected under the [LICENSE](https://choosealicense.com/licenses) License. For more details, refer to the [LICENSE](https://choosealicense.com/licenses/) file.
